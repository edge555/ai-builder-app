...
export const REFERENCE_PROMPTS: ReferencePrompt[] = [
  ...
  // ── Classroom / Beginner prompts ──
  {
    ...
    minFiles: 3,
    maxFiles: 8,
    requiredFiles: ['App.tsx', 'package.json'],
    requiredPatterns: ['useState', 'onClick'],
    forbiddenPatterns: ['prisma', 'next.config'],
    description: 'Classroom beginner: counter',
  },
  {
    id: 'classroom-todo',
    ...
    requiredPatterns: ['useState', 'onClick'],
    forbiddenPatterns: ['prisma', 'next.config'],
    description: 'Classroom beginner: todo',
  },
  {
    id: 'classroom-quiz',
    ...
    requiredFiles: ['App.tsx', 'package.json'],
    requiredPatterns: ['useState', 'onClick'],
    forbiddenPatterns: ['prisma', 'next.config', 'fetch('],
    description: 'Classroom beginner: quiz',
  },
  {
    ...
    forbiddenPatterns: ['prisma', 'next.config', 'fetch('],
    description: 'Classroom beginner: form + list tracker',
  },
  {
    ...
    requiredPatterns: ['useState', 'onClick'],
    forbiddenPatterns: ['prisma', 'next.config', 'fetch('],
    description: 'Classroom beginner: calculator',
  },
