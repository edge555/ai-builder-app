...
- [ ] **2.1 — Add "Try Again" button to RepairStatus on failure**
...
- [ ] **2.2 — Wire ErrorMessage component into chat for generation failures**
...
- [ ] **2.4 — Suggest revert to last working version on repeated failures**
...
- [ ] **3.1 — Add popular device presets dropdown**
...
- [ ] **3.3 — Zoom control for device frames**
...
- [ ] **3.4 — Multi-device side-by-side view**
...
- [ ] **4.1 — Add timestamp diagnostics to Modal SSE events**
...
- [ ] **4.2 — Fix Modal FastAPI endpoint for async streaming**
...
- [ ] **4.3 — Add chunked encoding and flush control**
...
- [ ] **4.4 — Add streaming progress indicator parity with OpenRouter**
